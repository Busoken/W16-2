...
void main() async {
  ...
  group('test', () await {
    testWidgets('register', (WidgetTester tester) await {
      _overrideOnError();
      ...
      await tester.enterText(find.byKey(ValueKey('emailAddress_Create_ixlz')),
          'artsadawutwedathakarn@gmail.com');
      ...
      await tester.pumpAndSettle();
      expect(find.text('Success to create your account'), findsWidgets);
    });
    ...
    testWidgets('login', (WidgetTester tester) async {
      ...
      await tester.pumpAndSettle();
      await tester.enterText(find.byKey(ValueKey('emailAddress_49sr')),
          'artsadawutwethakarn@gmail.com');
      await tester.enterText(
          find.byKey(ValueKey('password_jm7y')), 'artsadawut12345');
      await tester.tap(find.byKey(ValueKey('Button_9kt9')));
      await tester.pumpAndSettle();
      expect(find.byKey(ValueKey('Text_o952')), findsWidgets);
    });

    testWidgets('viewcontent', (WidgetTester tester) async {
      _overrideOnError();
      ...
      await tester.pumpAndSettle();
      expect(find.byKey(ValueKey('Text_lcim')), findsWidgets);
    });
  });
}
